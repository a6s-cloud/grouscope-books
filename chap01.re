...
しかし、僕にはこのスタイルは合わないです。周りの人を鼓舞する言葉やビジョンを掲げられません。そして対面で進めていく方式ではなく、リモートが主であるためリーダが引っ張っていく形では上手くいかないのではと考えました。

そして、今回は仕組みづくりでモチベーションを上げていくアプローチを目指すことにしました。人に依存しない仕組みは、再現性の検証がしやすいです。
新しくチーム開発を進めるときにも導入しやすいというメリットがあります。

==== README駆動：見た目を豪華にして気分向上
まずは見た目から入ろうと考えました。
GitHubを使ったチーム開発といえば、やはり最初はREADMEになると思います。
このREADMEを豪華にして、テンションを上げていく作成です。
アイコンや理念、構成図、アウトプット記事などのアピールできるものを集約して載せるようにしました。アウトプットを一箇所に集めることで「やっている感」がでて、もっとREADMEを豪華にした欲求もでてきます。
...
==== タスクは細かくする
チーム開発を続けていくコツは、少ない時間でもいいので毎日触れて作業をすることだと考えています。少ない時間で作業するにはタスクは細かく、明確化にする必要があります。

そのため、issueは細かい単位で分けることにしました。30分で完了できる作業を１つのissueにするよう心がけていました。実際にタスクを小さくしてからは、以前の大きなタスクより手が付けやすい状態になりました。

==== 前に進んでいることを感じよう
エンジニアならGitHubに草を生やすことでモチベーションは上がりますよね？
...
自分のプライベートの時間を費やすので楽しくなければ続けられません。
僕がどんな所が楽しかったのかを振り返ってきます。

==== 皆で決めていく流れが楽しい
個人で進める時は自分一人で考え、決定していきます。
しかし、チームだと皆で決めていくことになります。
それぞれの意見を出し合いディスカッションして、ベストやベターを探していく流れは一人では味わうことができない楽しさがありました。

==== 仕組みを０から構築できて楽しい
今回は人も仕組みも0からのスタートでした。
そのような中でGitHubの運用フローやタスクの洗い出しなどの仕組みを試行錯誤しながら作っていきました。0から徐々に１になり、2になり、10になる過程を経験できて楽しかったです。

==== 自分の知らない技術を知ることが楽しい
１人で開発しているともっと良い書き方があるのではと悩むことがありますが、レビューしてもらうことで考えの幅が広がりした。
...
これまで、僕の気持ちや考えを伝えました。そして、皆さんは「自分ならもっと上手くできる」、「私ならこんな工夫する」など考えがあると思います。
