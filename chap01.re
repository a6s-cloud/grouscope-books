...
僕はプライベートでチーム開発することに対して憧れを持っていました。
そして2019年2月からチーム開発を始めることになりました。

仕事でもチームで開発しているので、同じ要領で進めていけば上手くいくだろうと考えていました。
しかし、実際に始めると何から決めればいいのだろう？まとまった時間が取れず中々進まない。作るものの認識確認ができていない。などの課題が出てきます。
ネットで「チーム開発 進め方」と調べても仕事よりの話が多く、プライベートでの進め方はありませんでした。
その為、PDCAのサイクルを回しながら手探りで進めて行きました。上手くいったこと、上手くいかなかったは沢山あります。

そこで本章では僕(なおと)の感情面にフォーカスして実際にプライベートでチーム開発やってみてどうだったかについて振り返っていきます。
