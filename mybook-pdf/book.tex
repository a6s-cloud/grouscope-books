...
\makeatletter
\def\@subtitle{ccccc}
\def\@pubevent{コミケ96（2019年夏）新刊}
\def\@latestpubhistory{2019年8月9日　ver 1.0}
\makeatother
\author{aaa　著}
\date{2019{-}08{-}09 版\hspace{2zw} 発行}
%%%
\begin{titlepage}
...
bbbb \par}%
    \vskip 1em%
    {\Large {\rmfamily --- } ccccc {\rmfamily --- } \par}%
    \vskip 15em%
    {\LARGE
      \lineskip .75em
      \begin{tabular}[t]{c}%
      ...
      \end{tabular}\par}%
    \vfill
    {\large 2019{-}08{-}09 版\hspace{2zw} 発行\par}%
\vskip4zw\mbox{}
  \end{center}%
  \fi                    %%%%%%%%%%
\end{titlepage}
...
{\noindent\reviewtitlefont\Large aaa
bbbb} \\
\medskip
{\noindent\reviewtitlefont ccccc} \\
