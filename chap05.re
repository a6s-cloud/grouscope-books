...
//footnote[chenv_09][余談ですが2019年01月07日、bash のバージョン5系がリリースされたとChet Ramey 氏のメーリングリストによって公開されました。現在ではLinux でも使えるようになってきており、Mac においてもbrew  でアップデートすれば使えるようになっています]
...
␣␣␣␣-regex␣"^index[0-9]+\.html$"␣-exec␣chmod␣644␣{}␣\;
//}
