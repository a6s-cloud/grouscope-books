...
//image[chap05/0013_AReportFromToki][トキさんからいただいた報告][scale=0.65]

な、なんと動かないという報告をいただいたのです。OS は違くとも同じbash 環境で動かしているスクリプト。そしてトキさんと同じMac 環境である、なおとさんの手元でもビルドは成功していると報告を受けています。何が原因だったのでしょうか。
