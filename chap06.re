...
==== フリーランスをずっと続けていくのか？
フリーランスになって、単価交渉や案件選択など自分で自分に決めることができるようになりました。
自己責任のもとで、自分の人生を自分で決めることができる。こういった感覚を持てているので、今の所フリーランスは楽しいです。

ただ、フリーランスに固執しているわけではないので、自分に合う会社なら正社員に戻ると思います。
自分のやりたいことができる環境であれば、契約形態に拘りはないです。

直近では色々な現場を経験して、スキルアップしたいと考えています。

==== どの技術分野をやっていきたいのか？
正社員時代は広く浅くのフルスタックでしたが、フリーランスとして活動するなら特化した技術が必要だと感じています。
今の所はクラウド系を主戦場にしていきたい気持ちです。

==== マネジメントやプロダクト作りは興味ないのか？
マネジメントやプロダクト作りに対して興味は湧いていないです。
自分の中で解決したい問題が明確化した際には、プロダクト作りをやりたい気持ちになるかもしれません。
ただ、今はまだ技術志向のようです。

=={sec-ext} 集まった場所
=== 【上野】いいオフィス
御徒町にある、株式会社LIG により運営されているコワーキングスペースです。
都営大江戸線、つくばエクスプレス線「新御徒町駅」から徒歩1分、もしくはJR 御徒町駅から徒歩10分前後程の場所に位置しており、アパートや商店街などが並ぶ通りの中にポツリとおしゃれなオープンテラスと木材を基調とした内装を有した落ち着いた空間となっています。

コーヒーや紅茶、お茶が飲み放題です。Wi-Fi とホワイトボード、電源、モニターが完備されています。
...
普段東京の騒がしい環境の中で過ごしている人たちにとって、たまには静かに落ち着いて勉強やプログラミングをしたいという人たちにとってのオアシスとなるような場所です。
...
池袋駅周辺といえば東京の中でも特に人が多くて賑やかな場所ですが、部屋に入った途端静かで落ち着ける空間に入ることができます。
池袋駅周辺は飲み屋街も多くあるので、いいオフィスを利用して一杯勉強した後には自分へのご褒美として居酒屋へ...という使い方もおすすめです。
...
アルコールを取り入れて開発を促進しようと考えていたのです。そのアルコールのお供として上野酒場情熱ホルモンさんにて美味しいホルモンをいただきました。ちなみにグルメ通なToki さんがお薦めする部位はコプチャンで、メニューに迷ったらそれを頼んでおくのも得策です。

JR 御徒町駅から徒歩3分程度、上野駅からでも数分程度で行けるところに位置しており休日のみならず平日の仕事帰りにも利用できる会話と料理とお酒がすすむザ・下町な雰囲気の場所となっています。
香ばしいホルモンを焼いた煙と滴る脂、ビールとハイボールが何杯も進む体験し、チームの結束力をより一層深めることができました。
...
池袋に多くの支店ができる程の人気なお店で、身が大振りで程よく塩味が効いた香ばしいやきとんが、ビールや焼酎等のお酒と非常に相性が良いです。
座席はテーブル席とカウンター席があり、複数人でも一人でも気兼ねなく利用することができます。
店舗はJR 池袋駅を囲むように複数構えており東口にもお店があるので、普段池袋に勤務している人や頻繁に池袋に足を運ぶ人は帰り道の途中に木々屋さんが無いか調べてみると結構あると思うので、仕事を頑張った帰りに一人飲みや気が置けない友人を軽く誘って飲みに行くのも良いかも知れません。
...
そういった趣のある空間であるため、親密な友人や重要な取引先、もしくは大切な人を連れたデートシーンに利用して、普段することのない深い話をやってみるのも良いでしょう。そして、より深い友情や関係性を築くことができるでしょう。
